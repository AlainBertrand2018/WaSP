...
export default function FaqPageContent({ initialFaqs = [] }: FaqPageContentProps) {
  ...
  if (!isMounted) {
    return <AiLoadingSpinner show title="Loading FAQs..." />;
  }
        ...
        <section className="container mx-auto px-4 py-20 lg:py-32">
          <div className="flex flex-col gap-8 max-w-4xl mx-auto">
            ...
            {initialFaqs.length === 0 ? (
              <AiLoadingSpinner show title="CLAIRE is fetching the FAQs..." />
            ) : (
              <Accordion
                type="single"
                collapsible
                className="w-full bg-card p-4 sm:p-8 rounded-lg"
              >
                ...
                <Dialog>
                  ...
                  <DialogContent className="sm:max-w-2xl">
                    ...
                    <div className="space-y-4 text-sm text-muted-foreground max-h-[70vh] overflow-y-auto pr-4">
                      <p>
                        BusinessStudio AI is a Made-in-Mauritius Webapps-as-Software
                        Platform (WaSP) that helps entrepreneurs, SMEs and executives
                        validate ideas, build financial plans, and create investor-ready
                        business plans—fast.
                      </p>
                      <p>
                        Built by Alain Bertrand, BusinessStudio AI is designed with an
                        AI-first, digital-first mindset to give Mauritian entrepreneurs
                        and executives a real competitive edge.
                      </p>
