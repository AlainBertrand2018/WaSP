...
const testimonials = [
  {
    quote:
      'BusinessStudio AI transformed my vision of creating, launching, and managing a business in Mauritius. The insights from the idea validation were pure gold. One can go from a vague concept to an investor-ready plan in less than a week.',
    author: 'Wesley R.',
  ...
  {
    quote:
      "As a solo founder, the budget planner and MVP roadmap were lifesavers. It felt like having a co-founder who's an expert in finance and product.",
    author: 'Stephan T.',
  ...
  {
    quote:
      "The most comprehensive startup tool for the Mauritian market. Period. The localization of the AI's analysis is what sets it apart.",
    author: 'Dona M.',
  ...
  {
    quote:
      'We secured our pre-seed funding using the business plan generated by this platform. The financial projections were spot-on and gave our investors confidence.',
    author: 'Jean-Marc P.',
  ...
  {
    quote:
      "This is not just a tool; it's a mentor. It guides you, asks the right questions, and forces you to think critically about every aspect of your business.",
    author: 'Laura M.',
  ...
  {
    quote:
      'The ability to go from a simple idea to a full PRD is incredible. It streamlined our entire product development process and saved us countless hours.',
    author: 'Katherina S.',
      ...
      <main className="flex-1">
            ...
            <div className="mt-12 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
              ...
              <Card className="bg-card text-card-foreground p-6 flex flex-col">
                ...
                <CardContent className="flex-grow space-y-4 text-left">
                  <p>For entrepreneurs and Business owners who want get a feel of BusinessStudio.</p>
                ...
                <Button asChild variant="outline" className="w-full mt-6">
                  <Link href="/login?redirect=/apps">Get Started</Link>
                </Button>
              </Card>
              {/* Business Tool Kits */}
              ...
              <Card className="bg-card text-card-foreground p-6 flex flex-col">
                ...
                <CardContent className="flex-grow space-y-4 text-left">
                  <p>
                    For established companies and agencies who need to implement reliable AI-driven tools, protocols and
                    workflows in-house.
                  </p>
                  <ul className="space-y-2">
        ...
        <section id="testimonials" className="bg-secondary py-20 lg:py-32">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="mt-4 max-w-2xl mx-auto text-lg text-primary-foreground/70">
              Don't just take our word for it. Here's what founders and business owners are saying about BusinessStudio AI.
            </p>
            <Carousel
