...
Based on this conversation, provide a helpful answer. Be friendly but professional.
If the question is outside your scope of expertise, politely state that you can only answer questions about the Mauritian business landscape.`,
});
